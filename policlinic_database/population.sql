...
INSERT INTO medical_consults (medical_consult_date, medical_consult_time, patient_id, doctor_id, medical_consult_type)
	VALUES 
		...
		('2024-07-03', '14:00:00', 3, 3, 'General'),
		('2024-07-04', '15:30:00', 4, 4, 'Especializado'),
		('2024-07-05', '09:00:00', 5, 5, 'General'),
...
INSERT INTO technical_consults (technical_consult_date, technical_consult_time, patient_id, technician_id, notes) 
	VALUES 
		...
		('2024-07-08', '13:45:00', 8, 8, 'Tomografía de tórax realizada.'),
		('2024-07-09', '16:15:00', 9, 9, 'Ultrasonido del abdomen realizado.'),
...
INSERT INTO medical_record (patient_id, consult_date, diagnosis, treatment, notes) 
	VALUES 
		...
		(3, '2024-07-03', 'Migraña crónica', 'Analgésicos recetados', 'Recomendación de consulta con neurólogo.'),
		(4, '2024-07-04', 'Diabetes tipo 2', 'Insulina recetada', 'Control mensual requerido.'),
		(5, '2024-07-05', 'Artritis', 'Antiinflamatorios prescritos', 'Recomendación de fisioterapia.'),
		(6, '2024-07-06', 'Asma', 'Inhalador recetado', 'Evitar desencadenantes conocidos.'),
		(7, '2024-07-07', 'Depresión', 'Antidepresivos recetados', 'Revisión en dos semanas.'),
		(8, '2024-07-08', 'Hipotiroidismo', 'Terapia de reemplazo hormonal', 'Chequeo trimestral.'),
		(9, '2024-07-09', 'Anemia', 'Suplementos de hierro recetados', 'Revisión en un mes.'),
...
INSERT INTO payments (payment_date, amount, payment_method, medical_consult_id, technical_consult_id) 
	VALUES 
		...
		('2024-07-03', 200.00, 'Debito', 3, 2),
		('2024-07-04', 250.00, 'Seguro', 4, 3),
		('2024-07-05', 120.00, 'Efectivo', 5, 4),
		('2024-07-06', 180.00, 'Credito', 6, 5),
		('2024-07-07', 220.00, 'Debito', 7, 6),
		('2024-07-08', 300.00, 'Seguro', 8, 7),
		('2024-07-09', 130.00, 'Efectivo', 9, 8),
		('2024-07-10', 170.00, 'Credito', 10, 9);